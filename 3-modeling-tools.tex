...
\begin{figure}[h]
	...
	\caption{Vertical profiles of resolved-scale vertical heat flux (left) and TKE (right) at intervals of 10 minutes during the first hour of simulation spin-up. Black lines indicate the initial condition where both quantities are zero everywhere.}
	\label{fig:heat-flux}
\end{figure}
